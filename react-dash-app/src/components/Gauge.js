...
class Gauge extends Component {
  ...
  render () {
    return (
      <div className={this.props.chartID}>
        { this.props.chart }
      </div>
    )
  }
  ...
  drawGauge = () => {
    ...
    // Creates faux Div and stores virtual DOM in state.chart
    // var faux = this.props.connectFauxDOM('div', 'chart')
    // console.log(faux)

    var name = this.props.name
    var value = this.props.value;
    var gaugeLowerBound = this.props.gaugeLowerBound;
    var gaugeUpperBound = this.props.gaugeUpperBound;
    var gaugeMaxValue = this.props.gaugeMaxValue;
    var chartID = this.props.chartID;
    var firstArc = this.props.firstArc;
    var secondArc = this.props.secondArc;
    var thirdArc = this.props.thirdArc;


    // données à calculer
    var percentValue = value / gaugeMaxValue;

    var arcFirst = gaugeLowerBound / gaugeMaxValue
    var arcSecond = (gaugeUpperBound - gaugeLowerBound) / gaugeMaxValue
    var arcThird = (gaugeMaxValue - gaugeUpperBound) / gaugeMaxValue
